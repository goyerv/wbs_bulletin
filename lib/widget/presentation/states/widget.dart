...
PreferredSizeWidget? appBar(BuildContext context, void Function(void Function() n) setState) {
  ...
  return AppBar(
    ...
    title: TextButton(onPressed: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (BuildContext context) => const Homepage())), child: Text(AppLocalizations.of(context).translate('News'), style: Theme.of(context).textTheme.titleLarge)),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Flexible(child: TextButton(onPressed: () => launchUrl(uriCareers), focusNode: focusNodeOne, child: Text(AppLocalizations.of(context).translate('Careers'), style: Theme.of(context).textTheme.labelSmall),)),
            
            Flexible(child: TextButton(onPressed: () => launchUrl(uriResources), focusNode: focusNodeOne, child: Text(AppLocalizations.of(context).translate('Resources'), style: Theme.of(context).textTheme.labelSmall),)),

            
            Row(children: [Flexible(child: Semantics(button: true, label: AppLocalizations.of(context).translate('Globe(Language) icon'), child: IconButton(onPressed: () => Navigator.of(context).push(MaterialPageRoute<void>(builder: (BuildContext context) => const Languages())), icon: Icon(Icons.language), hoverColor: defaultColor, focusNode: focusNodeTwo))), Flexible(child: Text(language, style: Theme.of(context).textTheme.bodySmall)) ],)
