...
Click the **Fork** button at the top right of the [repository](https://github.com/goyerv/wbs_bulletin) to create your own copy.

### 2. Clone Your Fork
```bash
git clone https://github.com/your-username/wbs_bulletin.git
